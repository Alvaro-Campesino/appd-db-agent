...
*/}}
{{- define "appdynamics-db-agent.name" -}}
...
*/}}
{{- define "appdynamics-db-agent.fullname" -}}
...
*/}}
{{- define "appdynamics-db-agent.chart" -}}
...
helm.sh/chart: {{ include "appdynamics-db-agent.chart" . }}
{{ include "appdynamics-db-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app: app-dynamics-db-agent
{{- end }}
